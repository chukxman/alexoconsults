...
function updateLGAs() {
    ...
    // Check if state is selected and exists in lgaList
    if (selectedState && lgaList[selectedState]) {
...
// Function to populate state options on page load
